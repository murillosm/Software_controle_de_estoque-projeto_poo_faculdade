...
public class CadastroClienteJuridicoHelper implements Helper{
	private final CadastroClienteJuridicoJDialog view;
	//private final TabelaClientesF tabelaClientesF;

	public CadastroClienteJuridicoHelper(CadastroClienteJuridicoJDialog view) {
		this.view = view;
	...
	@Override
	public ClientePessoaJuridico obterModelo(){
		...
		ClientePessoaJuridico cliente = new ClientePessoaJuridico(nome, cnpj, razaoSocial, fone1, fone2, email, endereco);
		return cliente;
	}
