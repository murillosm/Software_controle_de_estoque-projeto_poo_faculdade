...
public class FornecedorView extends JInternalFrame {
	...
	public FornecedorView() {
		...
		setBounds(100, 100, 818, 613);
		getContentPane().setLayout(null);
		
		JPanel panel = new JPanel();
		panel.setBounds(0, 520, 802, 63);
		...
		txtCpf.setBounds(126, 52, 248, 20);
		...
		txtDataNasc.setBounds(126, 77, 476, 20);
		...
		JLabel lblFornecedor = new JLabel("Cadastro Fornecedor");
		lblFornecedor.setFont(new Font("Tahoma", Font.BOLD, 30));
		lblFornecedor.setHorizontalAlignment(SwingConstants.CENTER);
		lblFornecedor.setBounds(10, 11, 782, 46);
